...
#The diamonds data set is big, therefore we will separate the file in smaller data sets
#We randomly select the rows using seed function, and replace=F indicates 
#that we do not have duplicates
...
# Save data
save(list = c("diamonds.big", "diamonds.small", "diamonds.tiny"), file = "G:/mihaela/TEACHING/diamonds.RData")
