...
# Questions:
#can cut, color or clarity of a diamond as point color highlight some additional pattern for describing price?
...
# custom color palette (scale_color_manual)
...
# scale_color_brewer  - Sequential, diverging and qualitative color scales from colorbrewer.org
diamonds.small %>% 
  ggplot(aes(x = carat, y = price, color = cut)) +
  geom_point(size = 3, position = "jitter") +
