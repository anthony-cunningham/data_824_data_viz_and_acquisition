...
#range -	a numeric vector of length 2 that specifies the minimum and maximum size
#of the plotting symbol after transformation
...
# scale_size - custom breaks - we can add more binns 
diamonds.small %>% 
  ggplot(aes(x = carat, y = price, size = volume)) +
  geom_point() +
