...
* car highway miles consumption prediction modeling
...
In the final section of the report we would like to build models for car highway miles consumption predictions. Each model will use different variables as predictors (different number of variables and different types of variables). Some guidelines in model building:

* target variable (dependent variable): **hwy** 
* selected predictor variables (independent variables): **cty**, **displ**, **cyl**, **drv**, **fl**
...
# Functions needed: add the correct path of these functions
source("G:/mihaela/05_functions.R")
