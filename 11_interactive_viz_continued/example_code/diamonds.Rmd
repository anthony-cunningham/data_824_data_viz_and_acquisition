...
First let's compare diamond carat with diamond price using scatterplot. As you can see from the figure, price variability is increased when we increase the value of the carat.
...
The following three figures show each dimension variable with diamond price. First we compare diamond length with diamond price using heatmap (bin count).
...
The second depicts connection between price and diamond width using 2 dimensional density plot.
