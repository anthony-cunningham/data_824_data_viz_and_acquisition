...
# Matrix plots
# compare all pairs of variables and visualize comparison
# draw proper graphics - depends which types of variables you are comparing
#   - on diagonal - distribution of each variable is visualized
#   - when two variables are compared different types of graphics are used
#   - correlation coefficient is calculated for 2 continuous variables

#The ggpairs() function of the GGally package allows to build a great scatterplot matrix.
#Scatter plots of each pair of numeric variable are drawn on the left part of the figure. 
