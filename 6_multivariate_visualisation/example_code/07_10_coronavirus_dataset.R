...
# data import
infected <- read.csv(file = "G:/mihaela/TEACHING/time_series-ncov-Confirmed.csv", 
                     colClasses = "character")
killed <- read.csv(file = "G:/mihaela/TEACHING/time_series-ncov-Deaths.csv", 
                   colClasses = "character")
recovered <- read.csv(file = "G:/mihaela/TEACHING/time_series-ncov-Recovered.csv", 
                      colClasses = "character")
